...
significant_DEGs <- results_annotated[results_annotated$adj.P.Val < 0.05 & abs(results_annotated$logFC) > 1, ]
write.csv(significant_DEGs, "~/Project/week1/OVERALL_FEMALE_1.csv", row.names = FALSE)
